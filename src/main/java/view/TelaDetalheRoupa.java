...
public class TelaDetalheRoupa implements ActionListener {
    ...
    public void inserirEditar(int op, ControleDados d,
        ...
        if (op == 2) {
            s = "Cadastro de Camisa";
        }
        if (op == 3) {
            s = "Cadastro de Camiseta";
        }
        if (op == 4) {
            s = "Cadastro de Casaco";
        }
        if (op == 5) {
            s = "Cadastro de Cinto";
        }
        if (op == 6) {
            s = "Cadastro de Cropped";
        }
        if (op == 7) {
            s = "Cadastro de Macacão";
        }
        if (op == 8) {
            s = "Cadastro de Saia";
        }
        ...
        if (op == 15) {
            s = "Detalhe de Cropped";
        }
        if (op == 16) {
            s = "Detalhe de Macacão";
        }
        if (op == 17) {
            s = "Detalhe de Saia";
        }
